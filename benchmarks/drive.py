...
CASES = {
 ...
 "lcms2/cmsOpenProfileFromMem": dict(
    ...
    # SEEDS FROM LITTLE-CMS'S OWN PROFILE WRITER, generated by benchmarks/targets/lcms2.sh,
    # with the testbed directory kept behind them. An ICC profile is a 128-byte header, a
    # tag table and tag data whose offsets must agree; a mutator does not reach that by
    # accident, and this case has been running on whatever the testbed happened to hold --
    # 10 files for 5.00% across 43 million executions, almost all rejected in the header.
    seeds=["/b/lcms2/hf-seeds", "/b/lcms2/testbed"], max_len=65536,
