...
| `P3` | producers: test-lift, LLM->IR, graph traversal | 42/50 | partial |
...
**87 of 110 deliverables done**, and `plancheck` refuses to let any of them say so without a module that imports and a test that exists.
