...
| **OGHarn** | coverage vs the developer harness | +14% median (1.14x bar) | **0.87–0.96x** of the developer harness | **LOSS / not-yet-powered** — below parity on 2–4 libs, UNDERPOWERED (need >=5). Stated plainly. |
...
- **Raw coverage vs a tuned developer harness (OGHarn's axis): we are below (0.87–0.96x) and
  the sample is underpowered.** This is the honest headline loss.
